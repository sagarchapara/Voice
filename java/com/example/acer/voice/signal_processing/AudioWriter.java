...
public class AudioWriter implements Runnable {
    ...
    // Write to a file
    public AudioWriter(File file, AudioFormat format, AudioFileFormat.Type targetType) throws IOException {
    ...
    public static void main(String[] args) {
        try {  File a = new File("M1F1-Alaw-AFsp.wav");
            ...
            double[] sam = new double[500];
            sam = sampleReader.getChannelSamples(1,samples,sam);
            for (int i = 484; i <500 ; i++) {
